    ...
    def restore_or_maximize_window(self):
        ...
        if win_status == 0:
            ...
            self.ui.restoreButton.setIcon(
                QtGui.QIcon("icons/cil-window-restore.png")
            )  # Show minized icon
            ...
            self.animation.setStartValue(100)  # Start value is the current menu width
            ...
            self.ui.restoreButton.setIcon(
                QtGui.QIcon("icons/cil-window-maximize.png")
            )  # Show maximize icon
            ...
            self.animation.setDuration(250)
            self.animation.setStartValue(350)  # Start value is the current menu width
