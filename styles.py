...
class Styles:
    ...
    accounts_button_styles = (
        u"background-image: url(icons/cil-user.png);\n"
    ...
    home_button_styles = (
        u"background-image: url(icons/cil-home.png);\n"
        "background-repeat: none;\n"
        "padding-left: 50px;\n"
        "background-position: center left;\n"
    ...
    about_button_styles = (
        u"background-image: url(icons/cil-people.png);\n"
        "background-repeat: none;\n"
        "padding-left: 50px;\n"
        "background-position: center left;"
    )
    ...
    input_fileds_frame_styles = (
        ...
        "	background-image: url(icons/cil-check.png);\n"
        "}"
    )
    ...
    profile_icon_frame_styles = (
        u"image: url(icons/cil-user-follow.png);\n"
        "background-color: rgb(34, 34, 34);\n"
        "border-radius: 25px;\n"
        "border: 3px solid rgb(0, 93, 159);"
    )
    ...
    show_data_btn_styles = (
        u"background-image: url(icons/cil-view-module.png);\n"
        "background-repeat: none;\n"
        "padding-left: 50px;\n"
        "background-position: center left;"
    )
    ...
    add_book_btn_styles = (
        u"background-image: url(icons/cil-plus.png);\n"
        "background-repeat: none;\n"
        "padding-left: 50px;\n"
        "background-position: center left;"
    )
    ...
    update_book_btn_styles = (
        u"background-image: url(icons/cil-pencil.png);\n"
        "background-repeat: none;\n"
        "padding-left: 50px;\n"
        "background-position: center left;"
    )
    ...
    delete_book_btn_styles = (
        u"background-image: url(icons/cil-trash.png);\n"
        "background-repeat: none;\n"
        "padding-left: 50px;\n"
        "background-position: center left;"
    )
    ...
    show_favorites_btn_styles = (
        u"background-image: url(icons/cil-heart.png);\n"
        "background-repeat: none;\n"
        "padding-left: 50px;\n"
        "background-position: center left;"
    )
    ...
    add_favorites_btn_styles = (
        u"background-image: url(icons/cil-star.png);\n"
        "background-repeat: none;\n"
        "padding-left: 50px;\n"
        "background-position: center left;"
    )
