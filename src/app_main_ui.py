...
class Ui_MainWindow(object):
  def setupUi(self, MainWindow):
    ...
    icon = QIcon()
    icon.addFile("src/icons/cil-menu.png", QSize(), QIcon.Normal, QIcon.Off)
    ...
    icon2 = QIcon()
    icon2.addFile("src/icons/cil-minus.png", QSize(), QIcon.Normal, QIcon.Off)
    ...
    icon1 = QIcon()
    icon1.addFile("src/icons/cil-window-maximize.png",
    ...
    icon3 = QIcon()
    icon3.addFile("src/icons/cil-x.png", QSize(), QIcon.Normal, QIcon.Off)
    ...
    self.formLayout.setWidget(
        1, QFormLayout.SpanningRole, self.accounts_button)
    ...
    self.verticalLayout_11.addWidget(
        self.sign_in_res_ok_btn, 0, Qt.AlignHCenter)
    self.verticalLayout_6.addWidget(
        self.sign_in_response_frame, 0, Qt.AlignHCenter)
    ...
    self.formLayout_2.setWidget(
        0, QFormLayout.FieldRole, self.profile_icon_frame)
    self.verticalLayout_8.addWidget(
        self.input_fileds_frame, 0, Qt.AlignHCenter)
    self.verticalLayout_6.addWidget(
  ...
  def retranslateUi(self, MainWindow):
    ...
    self.label_6.setText(
        QCoreApplication.translate(
            "MainWindow", "Library Management App", None)
    )
...
OS: Linux x64 5.11.0-43-generic snap\n "
    ...
    self.combo_box.setItemIcon(0, QIcon("src/icons/section.png"))
    self.combo_box.setItemText(
        1, QCoreApplication.translate("MainWindow", "Genres")
    )
    self.combo_box.setItemIcon(1, QIcon("src/icons/genre.png"))
    self.combo_box.setItemText(
        2, QCoreApplication.translate("MainWindow", "Books"))
    self.combo_box.setItemIcon(2, QIcon("src/icons/book.png"))
    self.combo_box.setItemText(
        3, QCoreApplication.translate("MainWindow", "Comments")
    )
    self.combo_box.setItemIcon(3, QIcon("src/icons/Comments.png"))
    self.combo_box.setItemText(
        4, QCoreApplication.translate("MainWindow", "Download_history")
    )
    self.combo_box.setItemIcon(4, QIcon("src/icons/down.png"))
    ...
    self.sign_in_response_frame.setStyleSheet(
        Styles.sign_in_response_frame_styles)
